    ...
    <div className="pb-16 md:pb-0">
      ...
      <div className="space-y-6 px-4 py-5 md:px-6">
        ...
        <section className="grid gap-3 sm:grid-cols-3">
          <Card className="p-4"><div className="text-xs uppercase text-muted">Open markets</div><div className="mt-1 text-2xl font-semibold text-white tabular">{openMarkets}</div></Card>
          <Card className="p-4"><div className="text-xs uppercase text-muted">Total markets</div><div className="mt-1 text-2xl font-semibold text-white tabular">{markets.length}</div></Card>
              ...
              <tbody className="divide-y divide-line">
                {audit.map((a) => (
                  <tr key={a.id} className="hover:bg-ink-700">
                    ...
                    <td className="px-4 py-2.5 text-gray-200">{a.actor}</td>
